...
<body class="text-center">
    <form id="form1" runat="server">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavDropdown">
                        <ul class="navbar-nav">
                            <li class="nav-item active">
                                <a class="nav-link" href="SendMail.aspx">Send Mail <span class="sr-only">(current)</span></a>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="login-form">
           ...
           <button type="button" runat="server" onserverclick="Button1_Click" class="btn btn-primary">Sign in</button>
            <br />
            <asp:LinkButton ID="LinkButton1" OnClick="LinkButton1_Click" runat="server">Create an account</asp:LinkButton>
